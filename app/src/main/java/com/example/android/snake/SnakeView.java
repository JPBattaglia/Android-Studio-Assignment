...
public class SnakeView extends TileView {
    ...
    private void initSnakeView() {
        ...
        resetTiles(4);
        loadTile(RED_STAR, r.getDrawable(redstar));
        loadTile(YELLOW_STAR, r.getDrawable(R.drawable.apple));
        loadTile(GREEN_STAR, r.getDrawable(R.drawable.rock));
        loadTile(HEAD, r.getDrawable(R.drawable.snakehead));
    ...
    private void updateSnake() {
        ...
        for (int appleindex = 0; appleindex < applecount; appleindex++) {
            ...
            if (c.equals(newHead)) {
                ...
                ///NEW CODE
                MediaPlayer MEDIA_PLAYER = MediaPlayer.create(getContext(), R.raw.crunch);
                MEDIA_PLAYER.start();
